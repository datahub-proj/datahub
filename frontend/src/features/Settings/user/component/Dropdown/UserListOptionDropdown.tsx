...
import DeleteUserModal from '@/features/Settings/user/component/Modal/DeleteUserModal';
import { useOutClick } from '@/hooks/useOuterClick';
import { useNavigate } from 'react-router-dom';

type UserListOptionDropdownProps = {
  userid: string;
};

const UserListOptionDropdown: React.FC<UserListOptionDropdownProps> = ({
  userid,
}: UserListOptionDropdownProps) => {
  ...
  useOutClick([dropdownRef, deleteModalRef], () => {
    if (dropdownOpen) {
      ...
      <div className="relative mt-1.5">
        ...
        {deleteModalOpen && (
          <DeleteUserModal
            ...
            handleModalOpen={setDeleteModalOpen}
          />
        )}
      </div>
    </div>
...
export default UserListOptionDropdown;
