  ...
  return (
    <div>
      <button
        ...
        className="inline-flex items-center justify-center gap-2.5 whitespace-nowrap rounded-full border border-primary py-2 px-5 text-center font-medium text-black dark:text-white hover:bg-opacity-90 lg:px-8 xl:px-10"
        {...props}
      >
        <span>
          <svg
