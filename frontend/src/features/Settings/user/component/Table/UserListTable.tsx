...
import { DebouncedInput } from '@/components/custom/Table/utils/DebounceInput';
import { fuzzyFilter } from '@/components/custom/Table/utils/filterfns';
...
const UserListTable = <T extends object>({
  data,
  columns,
  showFooter = false,
  showNavigation = true,
